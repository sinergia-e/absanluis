...
function get_organization_chart(datascource) {
  var oc = $('#chart-container').orgchart({
    ...
    'createNode': function($node, data) {
      ...
      secondMenu += '<img class="avatar add_node" title="Add New Child" id="' + data.id + '" src="/org_chart_employee_pro/static/src/img/add.png">';
      if (data.id != -1){
        secondMenu += '<img class="avatar edit_node" title="Edit Department" id="' + data.id + '" src="/org_chart_employee_pro/static/src/img/edit.png"><img class="avatar delete_node" title="Delete Department" id="' + data.id + '" src="/org_chart_employee_pro/static/src/img/delete.png">';
      }
      secondMenu += '</div>';
